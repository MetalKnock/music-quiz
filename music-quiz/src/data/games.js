...
const gamesData = [
  ...
  [
    ...
    },
    {
      ...
      genre: "Боевик",
      description:
        "Сюжет повествует о мальчике по имени Сора, который оказывается избранным Ключ-Клинком. Путешествуя между мирами, он сражается с силами тьмы. В начале путешествия к нему присоединяются Гуфи и Дональд Дак, которые помогают ему.",
      image: imgpsTwo6,
      audio: psTwo6,
    },
  ],
  ...
  [
    ...
    },
    {
      ...
      genre: "Платформер",
      description:
        "Levelhead повествует о маленьком роботе – сотруднике Бюро доставки, лучшей логистической службы в галактике! Клиенты уже более сотни лет доверяют компании! Поэтому вы должны сделать всё, чтобы начинающий робот GR-18 стал лучшим доставщиком, который не боится никаких опасностей, способен пройти через огонь, воду и трубы из инопланетного аналога меди, справиться с любыми противниками и вручить клиенту его посылку в целости и сохранности.",
      image: imgmobile5,
      audio: mobile5,
    },
    {
